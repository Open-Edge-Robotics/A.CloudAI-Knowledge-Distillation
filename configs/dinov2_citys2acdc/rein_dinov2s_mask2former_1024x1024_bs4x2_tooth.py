# dataset config
_base_ = [
    "../_base_/datasets/tooth.py",
    "../_base_/default_runtime.py",
    "../_base_/models/rein_dinov2s_mask2former_tooth.py",
]
crop_size = (1024, 1024)
model = dict(
    backbone=dict(
        img_size=1024,
        init_cfg=dict(
            checkpoint="checkpoints/dinov2s_converted_1024x1024.pth",
        ),
    ),
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type="AdamW", lr=0.00006, weight_decay=0.0005, eps=1e-7, betas=(0.9, 0.999)
    ),
    paramwise_cfg=dict(
        custom_keys={
