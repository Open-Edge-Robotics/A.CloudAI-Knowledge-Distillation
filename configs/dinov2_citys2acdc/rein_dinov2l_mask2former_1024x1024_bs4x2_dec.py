...
_base_ = [
    ...
    "../_base_/models/rein_dinov2l_mask2former.py",
]
crop_size = (1024, 1024)
model = dict(
    backbone=dict(
        img_size=1024,
        init_cfg=dict(
            checkpoint="checkpoints/dinov2l_converted_1024x1024.pth",
        ),
    ),
...
param_scheduler = [
    dict(type="LinearLR", start_factor=1e-6, by_epoch=False, begin=0, end=40000),
    dict(
        type="PolyLR",
        eta_min=0.0,
        power=0.9,
