...
def main():
    ...
    if 'storm' in args.config:
        ...
        testloader_fog = Runner.build_dataloader(cfg['val_dataloader_fog'])
        testloader_night = Runner.build_dataloader(cfg['val_dataloader_night'])
        testloader_rain = Runner.build_dataloader(cfg['val_dataloader_rain'])
        testloader_snow = Runner.build_dataloader(cfg['val_dataloader_snow'])
        ...
        condition_order = ['fog', 'night', 'rain', 'snow'] * 1
